         ...
         <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <div className="flex flex-wrap items-center gap-3">
               ...
               <button 
                  ...
                  className="h-10 px-4 bg-indigo-600 text-white hover:bg-indigo-700 transition-colors text-xs font-bold rounded-2xl flex items-center gap-2 shadow-sm disabled:opacity-50"
               >
                  New Reservation
               </button>
            </div>
