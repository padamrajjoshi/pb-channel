      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex items-center gap-4">
           ...
           <button 
             ...
             className="h-full px-6 bg-blue-600 hover:bg-blue-500 text-white rounded-2xl font-bold shadow-lg shadow-blue-500/20 active:scale-95 transition-all flex items-center gap-2"
           >
            ...
            >
               ...
               <div className="flex items-center justify-between border-t border-border mt-auto pt-4 z-10 relative">
                  <div className="flex items-center gap-2 text-muted-foreground text-xs font-bold uppercase tracking-widest">
                     ...
                     {promo.target_ota || promo.targetChannel || "Generic Net"}
                  </div>
                  <button className="p-2 hover:bg-muted dark:hover:bg-slate-800 rounded-lg transition-colors border border-transparent hover:border-border dark:hover:border-white/5">
